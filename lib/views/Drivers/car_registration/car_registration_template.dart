...
import 'package:taxi/views/Drivers/car_registration/pages/document_uploaded_page.dart';
import 'package:taxi/views/Drivers/car_registration/pages/loaction_page.dart';
import 'package:taxi/views/Drivers/car_registration/pages/upload_document_page.dart';
import 'package:taxi/views/Drivers/car_registration/pages/vehical_color_page.dart';
import 'package:taxi/views/Drivers/car_registration/pages/vehical_model_page.dart';
import 'package:taxi/views/Drivers/car_registration/pages/vehical_model_year_page.dart';
import 'package:taxi/views/Drivers/car_registration/pages/vehical_number_page.dart';
import 'package:taxi/views/Drivers/car_registration/pages/vehicle_make.dart';
import 'package:taxi/views/Drivers/car_registration/pages/vehicle_type_page.dart';
import 'package:taxi/controller/authController.dart';
import 'package:taxi/views/Drivers/verification_pending_screen.dart';
